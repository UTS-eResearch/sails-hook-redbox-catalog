...
(function (Controllers) {
    class CatalogController extends redbox_core_types_1.Controllers.Core.Controller {
        constructor() {
            super();
            ...
            if (reqInfo.requested_by && reqInfo.assigned_to && catalogId) {
                ...
                return CatalogService.sendGetToTable('sys_user', { email: reqInfo.assigned_to })
                    ...
                    if (response && response['result']) {
                        ...
                        throw (0, rxjs_1.throwError)(errorMessage);
                    }
                    ...
                    if (response && response['result']) {
                        ...
                        sails.log.error(response);
                        throw (0, rxjs_1.throwError)('Cannot find requested_by Id on Service Now');
                    }
