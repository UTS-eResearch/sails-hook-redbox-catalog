...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__form_field_publish_data_location_refresh_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publish-data-location-refresh.component.ts");
...
var fieldClasses = {
    ...
    'PublishDataLocationRefresh': { 'meta': __WEBPACK_IMPORTED_MODULE_20__form_field_publish_data_location_refresh_component__["b" /* PublishDataLocationRefreshField */], 'comp': __WEBPACK_IMPORTED_MODULE_20__form_field_publish_data_location_refresh_component__["a" /* PublishDataLocationRefreshComponent */] }
};
...
var FieldBase = /** @class */ (function () {
    ...
    FieldBase.prototype.setVisibility = function (data) {
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isObject"](this.visibilityCriteria) && __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'type') == 'function') {
            var fn = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this, __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'action'));
            if (fn) {
                var boundFunction = fn;
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'action', '').indexOf(".") == -1) {
                    boundFunction = fn.bind(this);
                }
                else {
                    var objectName = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'action', '').substring(0, __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.visibilityCriteria, 'action', '').indexOf("."));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__form_field_publish_data_location_refresh_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-publish-data-location-refresh.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45_mobx_angular__ = __webpack_require__("./node_modules/mobx-angular/dist/mobx-angular.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/catalog-form.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/catalog-form.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__catalog_service__ = __webpack_require__("./src/app/catalog.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_request_box_component__ = __webpack_require__("./src/app/components/request-box.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_catalog_display_component__ = __webpack_require__("./src/app/components/catalog-display.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 *
 */
var CatalogFormComponent = /** @class */ (function (_super) {
    __extends(CatalogFormComponent, _super);
    function CatalogFormComponent(elm, RecordsService, fcs, LocationService, CatalogService, translationService) {
        var _this = _super.call(this) || this;
    ...
    CatalogFormComponent.prototype.registerEvents = function () {
     ...
     * @return {[type]}
     */
    CatalogFormComponent.prototype.rebuildForm = function () {
     ...
     * @return {[type]}
     */
    CatalogFormComponent.prototype.watchForChanges = function () {
        this.setLoading(false);
        if (this.editMode) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], CatalogFormComponent.prototype, "oid", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], CatalogFormComponent.prototype, "editMode", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ...
    CatalogFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/catalog-form.html"),
            styles: [__webpack_require__("./src/app/catalog-form.component.css")],
        ...
        __param(4, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_3__catalog_service__["a" /* CatalogService */])),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"],
            ...
            __WEBPACK_IMPORTED_MODULE_3__catalog_service__["a" /* CatalogService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_shared_module__ = __webpack_require__("./redbox-portal/angular/shared/shared.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_request_box_component__ = __webpack_require__("./src/app/components/request-box.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__catalog_form_component__ = __webpack_require__("./src/app/catalog-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__catalog_service__ = __webpack_require__("./src/app/catalog.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_catalog_display_component__ = __webpack_require__("./src/app/components/catalog-display.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var CatalogModule = /** @class */ (function () {
    ...
    CatalogModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            exports: [],
            providers: [
                __WEBPACK_IMPORTED_MODULE_7__catalog_service__["a" /* CatalogService */]
            ],
            bootstrap: [
                __WEBPACK_IMPORTED_MODULE_6__catalog_form_component__["a" /* CatalogFormComponent */]
            ],
...
var CatalogService = /** @class */ (function (_super) {
    ...
    function CatalogService(http, configService) {
        var _this = _super.call(this, http, configService) || this;
        _this.configService = configService;
    ...
    CatalogService.prototype.waitForInit = function (handler) {
        var subs = this.initSubject.subscribe(handler);
        this.emitInit();
        return subs;
    };
    CatalogService.prototype.emitInit = function () {
        if (this.brandingAndPortalUrl) {
            this.initSubject.next('');
        }
    };
    CatalogService.prototype.getTypes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wsUrl, result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wsUrl = this.brandingAndPortalUrl + '/ws/catalog/types';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    CatalogService.prototype.createRequest = function (request, rdmpId, catalogId, workspaceInfo, workspaceType) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CatalogService.prototype.getUserInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CatalogService.prototype.getRDMPInfo = function (rdmp) {
        return __awaiter(this, void 0, void 0, function () {
            var wsUrl, result, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wsUrl = this.brandingAndPortalUrl + '/ws/catalog/rdmp';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
...
/***/ "./src/app/components/catalog-display.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CatalogDisplayField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CatalogDisplayComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
 ...
 *
 */
var CatalogDisplayField = /** @class */ (function (_super) {
    __extends(CatalogDisplayField, _super);
    function CatalogDisplayField(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        ...
        _this.requestNextAction = options['requestNextAction'] || 'Request Next Action';
        _this.valid = options['valid'] || {};
        _this.services = options['services'] || [];
        return _this;
    }
    ...
    CatalogDisplayField.prototype.createRequest = function (serviceId) {
        this.showCatalog = false;
        var selectedService = __WEBPACK_IMPORTED_MODULE_4_lodash_es__["b" /* find */](this.services, { id: serviceId });
    ...
    CatalogDisplayField.prototype.setRDMPInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rdmpInfo, recordMeta;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.catalogService.getRDMPInfo(this.rdmp)];
                    case 1:
                        rdmpInfo = _a.sent();
                        recordMeta = rdmpInfo.recordMetadata;
                        this.projectInfo = {
                            id: this.rdmp,
    ...
    CatalogDisplayField.prototype.createFormModel = function (valueElem) {
        if (valueElem === void 0) { valueElem = undefined; }
        if (valueElem) {
            this.value = valueElem;
        }
    ...
    CatalogDisplayField.prototype.setValue = function (value) {
        this.formModel.patchValue(value, { emitEvent: false });
        this.formModel.markAsTouched();
    };
    CatalogDisplayField.prototype.setEmptyValue = function () {
        this.value = [];
        return this.value;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
    ], CatalogDisplayField.prototype, "requestBox", void 0);
    return CatalogDisplayField;
}(__WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__["a" /* FieldBase */]));

/**
 * Component that CreateModal to a workspace app
 */
var CatalogDisplayComponent = /** @class */ (function (_super) {
    __extends(CatalogDisplayComponent, _super);
    function CatalogDisplayComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CatalogDisplayComponent.prototype.ngOnInit = function () {
        this.field.init();
    };
    CatalogDisplayComponent.prototype.ngAfterViewInit = function () {
        this.field.registerEvents();
    };
    CatalogDisplayComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
...
/***/ "./src/app/components/request-box.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RequestBoxField = /** @class */ (function (_super) {
    ...
    RequestBoxField.prototype.getValue = function (controlName, attr) {
        var obj = __WEBPACK_IMPORTED_MODULE_4_lodash_es__["b" /* find */](this.formArrayItems, function (el) {
    ...
    RequestBoxField.prototype.showRequestForm = function (req) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash_es__["e" /* forOwn */](this.requestFormElements, function (el, name) {
            ...
            if (el['type'] === 'checkbox') {
                var checkboxValue_1 = false;
                // Only auto tick on one value is supported for now.
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash_es__["g" /* isUndefined */](el['prefil'])) {
                    var obj = el['prefil'];
                    checkboxValue_1 = __WEBPACK_IMPORTED_MODULE_4_lodash_es__["f" /* get */](_this.projectInfo, obj.key, false);
                }
                _this.formCheckBoxArray[name] = __WEBPACK_IMPORTED_MODULE_4_lodash_es__["h" /* map */](el['fields'], function () {
                    return new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* FormControl */](checkboxValue_1);
                });
                _this.requestGroupForm.addControl(name, new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormArray */](_this.formCheckBoxArray[name]));
            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.catalogService.getTypes()];
                    case 1:
                        _a.storageType = (_b.sent()) || [];
                        return [2 /*return*/];
                }
            });
        });
    ...
    RequestBoxField.prototype.requestForm = function (form) {
        return __awaiter(this, void 0, void 0, function () {
            var workspaceInfo, catalogId, createRequest;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        workspaceInfo = this.getWorkspaceInfo(this.workspaceInfo, form);
                        catalogId = this.catalogId;
                        this.formError = false;
                        return [4 /*yield*/, this.catalogService.createRequest(form, this.rdmp, catalogId, workspaceInfo, this.workspaceType)];
                    case 1:
    ...
    RequestBoxField.prototype.getWorkspaceInfo = function (objs, form) {
        var info = {};
        __WEBPACK_IMPORTED_MODULE_4_lodash_es__["a" /* each */](objs, function (obj, key) {
            var msg = [];
            if (obj['concat']) {
                __WEBPACK_IMPORTED_MODULE_4_lodash_es__["a" /* each */](obj['concat'], function (c) {
                    if (form[c] && form[c]['value']) {
                        var value = form[c]['value'];
    ...
    RequestBoxField.prototype.setValue = function (value) {
        this.formModel.patchValue(value, { emitEvent: false });
        this.formModel.markAsTouched();
    };
    RequestBoxField.prototype.setEmptyValue = function () {
        this.value = [];
        return this.value;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
    ], RequestBoxField.prototype, "catalog", void 0);
 ...
 * Component that CreateModal to a workspace app
 */
var RequestBoxComponent = /** @class */ (function (_super) {
    __extends(RequestBoxComponent, _super);
    function RequestBoxComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RequestBoxComponent.prototype.ngOnInit = function () {
        this.field.init();
    };
    RequestBoxComponent.prototype.ngAfterViewInit = function () {
        this.field.registerEvents();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_catalog_module__ = __webpack_require__("./src/app/catalog.module.ts");
...
Object(__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_2__app_catalog_module__["a" /* CatalogModule */])
